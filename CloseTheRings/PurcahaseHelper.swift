...
typealias ProductWithExpireDate = [ProductIdentifier: Date]

typealias ProductsRequestHandler = (_ response: SKProductsResponse?, _ error: Error?) -> ()
typealias PurchaseHandler = (_ productIdentifier: ProductIdentifier?, _ error: Error?) -> ()
typealias RestoreHandler = (_ productIdentifiers: Set<ProductIdentifier>, _ error: Error?) -> ()
typealias ValidateHandler = (_ statusCode: Int?, _ products: ProductWithExpireDate?, _ json: [String: Any]?) -> ()
